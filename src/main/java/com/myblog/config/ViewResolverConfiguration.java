...
public class ViewResolverConfiguration {
    ...
    public class WebConfig extends WebMvcConfigurerAdapter {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/webapp/**").addResourceLocations("/WEB-INF/" + "/static/");
            registry.addResourceHandler("/webapp/**").addResourceLocations("/WEB-INF/"+"/static/"+"/Index/");
            registry.addResourceHandler("/webapp/**").addResourceLocations("/WEB-INF/"+"/static/"+"/Index/"+"/Public/");
            registry.addResourceHandler("/webapp/**").addResourceLocations("/WEB-INF/"+"/static/"+"/HT/");
        }
    }
