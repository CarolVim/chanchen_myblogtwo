...
<div class="ibox-content" id="node_box" style="display: none">
    <form class="form-horizontal m-t" method="post" action="{:url('node/nodeAdd')}" id="addForm">
...
<div class="ibox-content" id="edit_box" style="display: none">
    <form class="form-horizontal m-t" method="post" action="{:url('node/nodeEdit')}" id="editForm">
...
function getTree(){
    layui.use(['tree', 'layer'], function(){
        ...
        $.getJSON("{:url('node/index')}", function(res){
            if(111 == res.code){
                window.location.reload();
            }
            layui.tree({
