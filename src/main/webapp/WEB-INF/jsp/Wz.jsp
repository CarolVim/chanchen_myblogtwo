        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="" method="post" action="Change.do?shortId=${shortList.shortId}&&flag=2">
...
<script src="${pageContext.request.contextPath}/static/HT/static/js/bootstrap.min.js?v=3.3.6"></script>
